...
void test_schnorrsig_api(void) {
    ...
    CHECK(secp256k1_schnorrsig_sign_custom(CTX, sig, msg, sizeof(msg), &keypairs[0], &extraparams_s2c) == 0);
    CHECK(ecount == 7);
    extraparams_s2c = extraparams;
    extraparams_s2c.s2c_opening = &s2c_opening;
    ...
    CHECK(ecount == 0);
    CHECK(secp256k1_schnorrsig_verify_s2c_commit(CTX, NULL, s2c_data32, &s2c_opening) == 0);
    CHECK(ecount == 1);
    CHECK(secp256k1_schnorrsig_verify_s2c_commit(CTX, sig, NULL, &s2c_opening) == 0);
    CHECK(ecount == 2);
    CHECK(secp256k1_schnorrsig_verify_s2c_commit(CTX, sig, s2c_data32, NULL) == 0);
    CHECK(ecount == 3);
}
